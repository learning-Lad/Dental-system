                ...
                {appointments.map((item, index) => (
                    <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                        ...
                        <div className='flex-1 text-sm text-[#5E5E5E]'>
                            ...
                            {item.prescription && (
    <div className='mt-4 p-3 bg-blue-50 border border-blue-100 rounded-lg max-w-lg shadow-sm'>
        
        {/* Header Row with Print Button */}
        <div className='flex justify-between items-center mb-2'>
            <p className='text-xs font-semibold text-blue-800 flex items-center gap-1'>
                Rx / Prescription 
                <span className='font-normal text-blue-600 text-[10px]'>(from {item.docData.name})</span>
            </p>
            ...
            <button 
                onClick={() => {
                    ...
                    printWindow.document.write(`<h2>Prescription from ${item.docData.name}</h2>`);
                    printWindow.document.write(`<p><strong>Date:</strong> ${slotDateFormat(item.slotDate)}</p>`);
                    printWindow.document.write(`<hr/><p style="white-space: pre-wrap; font-size: 16px;">${item.prescription}</p>`);
