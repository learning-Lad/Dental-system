...
{
    isEdit
                                   ? <input className='bg-gray-50 text-3xl font-medium max-w-70' type="text" onChange={(e) => setProfileData(prev => ({ ...prev, name: e.target.value }))} value={profileData.name} />
                : <p className='font-medium text-3xl text-[#262626] mt-4'>{profileData.name}</p>
}
